...
# Create a new user with the specified UID, set its properties,
# and install the Python packages listed in requirements.txt
...
ENTRYPOINT ["python", "app.py", "-c", "/config/settings.yaml"]
